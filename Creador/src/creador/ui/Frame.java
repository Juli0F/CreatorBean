...
public class Frame extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtPath, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        chooser.setDialogTitle("Script sql");
        ...
        //Si seleccionamos algún archivo retornaremos su directorio
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                Load interprete = new Load();
                interprete.loadFile(sql, pathEntities, pathMysql, pathDao);
    ...
    public void file(){
        ...
        File entidades = new File(txtPath.getText()+File.separatorChar+"Entities");
        File dao = new File(txtPath.getText()+File.separatorChar+"DAO");
        File mysql = new File(txtPath.getText()+File.separatorChar+"MySql");
        
        pathEntities = carpeta(entidades);
        pathDao = carpeta(dao);
        pathMysql = carpeta(mysql);
    }
      public  String carpeta(File file){
           if (!file.exists()) {
               file.mkdir();
           }
